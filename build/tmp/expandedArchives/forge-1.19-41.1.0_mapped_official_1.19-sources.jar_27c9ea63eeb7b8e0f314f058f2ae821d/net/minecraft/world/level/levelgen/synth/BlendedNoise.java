...
public class BlendedNoise implements DensityFunction.SimpleFunction {
   ...
   public void parityConfigString(StringBuilder p_192818_) {
      ...
      p_192818_.append(String.format(", xzScale=%.3f, yScale=%.3f, xzMainScale=%.3f, yMainScale=%.3f, cellWidth=4, cellHeight=8", 684.412D, 684.412D, 8.555150000000001D, 4.277575000000001D)).append('}');
   }
