      ...
      if (!this.isChatHidden()) {
         ...
         if (j > 0) {
               ...
               if (guimessage != null) {
                  ...
                  if (j1 < 200 || flag) {
                     ...
                     if (l1 > 3) {
                        ...
                        p_93781_.translate(0.0D, 0.0D, 50.0D);
                        this.minecraft.font.drawShadow(p_93781_, guimessage.getMessage(), 0.0F, (float)((int)(d6 + d4)), 16777215 + (l1 << 24));
            ...
            if (!this.chatQueue.isEmpty()) {
               ...
               RenderSystem.enableBlend();
               p_93781_.translate(0.0D, 0.0D, 50.0D);
               this.minecraft.font.drawShadow(p_93781_, Component.translatable("chat.queue", this.chatQueue.size()), 0.0F, 1.0F, 16777215 + (k2 << 24));
               p_93781_.popPose();
               RenderSystem.disableBlend();
            }
