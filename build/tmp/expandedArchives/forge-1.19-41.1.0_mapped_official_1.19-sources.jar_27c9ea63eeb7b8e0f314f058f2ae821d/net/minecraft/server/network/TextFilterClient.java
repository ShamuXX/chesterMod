...
public class TextFilterClient implements AutoCloseable {
   ...
   CompletableFuture<FilteredText<String>> requestMessageProcessing(GameProfile p_10137_, String p_10138_, TextFilterClient.IgnoreStrategy p_10139_, Executor p_10140_) {
      return p_10138_.isEmpty() ? CompletableFuture.completedFuture(FilteredText.EMPTY_STRING) : CompletableFuture.supplyAsync(() -> {
         ...
         try {
            ...
            if (flag) {
               ...
               if (s == null) {
                  ...
                  return p_10139_.shouldIgnore(s, i) ? FilteredText.fullyFiltered(p_10138_) : new FilteredText<>(p_10138_, s);
               }
            }
         } catch (Exception exception) {
