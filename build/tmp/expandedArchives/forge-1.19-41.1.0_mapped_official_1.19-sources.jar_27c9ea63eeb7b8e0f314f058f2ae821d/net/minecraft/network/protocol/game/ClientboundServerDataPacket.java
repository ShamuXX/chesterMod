...
public class ClientboundServerDataPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundServerDataPacket(@Nullable Component p_237801_, @Nullable String p_237802_, boolean p_237803_) {
      this.motd = Optional.ofNullable(p_237801_);
      this.iconBase64 = Optional.ofNullable(p_237802_);
      this.previewsChat = p_237803_;
   }
