...
public class PlayerMenuItem implements SpectatorMenuItem {
   ...
   public PlayerMenuItem(GameProfile p_101756_) {
      ...
      Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> map = minecraft.getSkinManager().getInsecureSkinInformation(p_101756_);
      if (map.containsKey(Type.SKIN)) {
         this.location = minecraft.getSkinManager().registerTexture(map.get(Type.SKIN), Type.SKIN);
      } else {
         this.location = DefaultPlayerSkin.getDefaultSkin(UUIDUtil.getOrCreatePlayerUUID(p_101756_));
      }
