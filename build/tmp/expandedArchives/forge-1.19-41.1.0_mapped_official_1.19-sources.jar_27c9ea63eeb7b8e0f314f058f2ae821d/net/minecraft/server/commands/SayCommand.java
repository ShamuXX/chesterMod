...
public class SayCommand {
   public static void register(CommandDispatcher<CommandSourceStack> p_138410_) {
      p_138410_.register(Commands.literal("say").requires((p_138414_) -> {
         ...
         messageargument$chatmessage.resolve(commandsourcestack).thenAcceptAsync((p_214719_) -> {
            playerlist.broadcastChatMessage(p_214719_, commandsourcestack, ChatType.SAY_COMMAND);
