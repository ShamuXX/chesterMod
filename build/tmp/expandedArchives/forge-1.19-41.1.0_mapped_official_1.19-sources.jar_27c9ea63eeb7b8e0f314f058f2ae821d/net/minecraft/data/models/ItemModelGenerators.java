...
public class ItemModelGenerators {
   ...
   private void generateCompassItem(Item p_236322_) {
      for(int i = 0; i < 32; ++i) {
         if (i != 16) {
            this.generateFlatItem(p_236322_, String.format("_%02d", i), ModelTemplates.FLAT_ITEM);
         }
      }
   ...
   private void generateClockItem(Item p_236324_) {
      for(int i = 1; i < 64; ++i) {
         this.generateFlatItem(p_236324_, String.format("_%02d", i), ModelTemplates.FLAT_ITEM);
      }
